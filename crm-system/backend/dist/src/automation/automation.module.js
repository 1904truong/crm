...
const warranty_automation_service_1 = require("./services/warranty-automation.service");
const prisma_module_1 = require("../prisma/prisma.module");
const zns_module_1 = require("../zns/zns.module");
...
exports.AutomationModule = AutomationModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            zns_module_1.ZnsModule,
            interactions_module_1.InteractionsModule,
        ],
        controllers: [automation_controller_1.AutomationController],
        providers: [automation_service_1.AutomationService, warranty_automation_service_1.WarrantyAutomationService],
